...
- [ ] 🔨 Hands-on: [My first Action workflow](lab/01-My-first-workflow.md)
- [ ] Advanced [workflow syntax](https://docs.github.com/en/actions/using-workflows/workflow-syntax-for-github-actions)
- [ ] :coffee: Break
- [ ] GitHub Actions
- [ ] Types of Actions
- [ ] 🔨 Hands-on: [My first container Action](lab/02-My-first-action.md)
...
- [ ] 🔨 Hands-on: [Staged deployments](lab/03-Staged-deployments.md)
- [ ] :coffee: Break
- [ ] Action policies
- [ ] Running your workflows
- [ ] Sharing workflows
- [ ] 🔨 Hands-on: [Reusable workflows](lab/04_Reusable-workflows.md)
...
## Contact
Feel free to [raise an issue on GitHub](https://github.com/ava-innersource/actions-fundamentals-training/issues), or see our [security disclosure](./SECURITY.md) policy.
